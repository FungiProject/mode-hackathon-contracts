...
import "src/core/Facets/OwnershipFacet.sol";
import "src/core/interfaces/IDiamondCut.sol";
// import "src/core/Facets/PeripheryRegistryFacet.sol";
...
contract DiamondTest {
    ...
    function _addFacet(
        ...
        DiamondCutFacet(address(_diamond)).diamondCut(cut, _init, _initCallData);
